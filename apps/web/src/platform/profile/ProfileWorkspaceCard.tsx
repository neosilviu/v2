...
export function ProfileWorkspaceCard({ workspaces, currentWorkspace, selectedWorkspaceId, onSelectWorkspace, profile }: { workspaces: ProfileWorkspace[]; currentWorkspace: ProfileWorkspace | null; selectedWorkspaceId: string; onSelectWorkspace: (workspaceId: string) => void; profile: ProfileData }) {
