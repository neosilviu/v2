...
export function ProfileSecurityCard({ profile, currentWorkspace, selectedWorkspaceId, onOpenSessions }: { profile: ProfileData; currentWorkspace: ProfileWorkspace | null; selectedWorkspaceId: string; onOpenSessions: () => void }) {
