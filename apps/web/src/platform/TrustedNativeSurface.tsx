...
type TrustedRegistryModule = {
  trustedSurfaces: Record<string, ComponentType<TrustedSurfaceProps>>;
};

const registryModules = import.meta.glob<TrustedRegistryModule>(
  "../../../../plugins/*/ui/registry.tsx",
  { eager: true },
);
const trustedSurfaces = Object.values(registryModules).reduce<
  Record<string, ComponentType<TrustedSurfaceProps>>
>((registry, module) => ({ ...registry, ...module.trustedSurfaces }), {});
