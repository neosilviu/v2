import { declarativeUiSchema, type SurfaceContribution } from "@v2/plugin-contracts";
import { declarativePageContributionSchema } from "@v2/ui-schema";
import { Badge, Button, SurfaceCard } from "@v2/ui-kit";
import { TemplateRenderer } from "./TemplateRenderer";

type LegacyDeclarativeUi = { body: Array<{ type: "text"; text: string; tone: "default" | "muted" | "accent" } | { type: "metric"; label: string; value: string; detail?: string | undefined } | { type: "action"; label: string; commandId: string; variant: "default" | "primary" }> };

export function DeclarativeBlock({ block }: { block: LegacyDeclarativeUi["body"][number] }) {
