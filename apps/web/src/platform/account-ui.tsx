        ...
        <div className="user-popover">
          <SurfaceCard className="user-popover-card">
            ...
            <div className="user-popover-body">
              <small>Workspace</small>
              <strong>
                {workspace?.name ?? workspace?.id ?? "No workspace"}
              </strong>
            ...
            <div className="user-popover-actions">
              {accountPath ? (
                <button
                  type="button"
                  onClick={() => closeAndRun(() => onOpenPath(accountPath))}
                >
                  Profile
                </button>
              ) : null}
              {settingsPath ? (
                <button
                  type="button"
                  onClick={() => closeAndRun(() => onOpenPath(settingsPath))}
                >
                  Settings
                </button>
              ) : null}
              <button type="button" onClick={() => closeAndRun(onSignOut)}>
                Sign out
              </button>
            </div>
          </SurfaceCard>
