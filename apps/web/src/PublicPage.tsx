...
export function PublicPage() {
  ...
  useEffect(() => {
    void loadPublicPage(window.location.pathname).then((result) => setPage(result.page)).catch((reason: unknown) => setError(reason instanceof Error ? reason.message : "Public page unavailable"));
  }, []);
