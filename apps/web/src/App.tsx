...
export function App() {
  ...
  return <>
    <div className="app-shell">
      ...
      <aside className="assistant">{assistant.length ? assistant.map((surface) => <div className="chat" key={surface.id}><div className="chat-header"><strong>{surface.title}</strong><Badge>#general</Badge></div><div className="message">I can operate active workspace tools after permission checks.</div><div className="composer">Ask Agent AI… <span>↵</span></div></div>) : <div className="message">Assistant surface is mounted in another zone.</div>}</aside>
