...
export function createSurfaceRoutes() {
  ...
  routes.get("/surfaces/:surfaceId", async (c) => {
    ...
    return c.body(html, 200, {
      ...
      "content-security-policy": "default-src 'none'; script-src 'unsafe-inline'; style-src 'unsafe-inline'; img-src data:; font-src data:; connect-src 'none'; form-action 'none'; frame-ancestors 'self'; base-uri 'none'; object-src 'none'",
