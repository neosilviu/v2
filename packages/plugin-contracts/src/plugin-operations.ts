...
export const pluginValueContractSchema: z.ZodType<PluginValueContract> = z.lazy(() => z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("string"), minLength: z.number().int().min(0).optional(), maxLength: z.number().int().min(0).optional() }),
...
export function validatePluginValue(contract: PluginValueContract, value: unknown, path = "input"): string | undefined {
